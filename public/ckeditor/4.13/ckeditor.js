...
(function() {
	...
	*/
	...
	(function() {
		...
		function M(a, b) {
			this.dialog = a;
			for (var c = b.contents, d = 0, e; e = c[d]; d++) c[d] = e && new N(a, e);
		...
		function ba(a) {
			function b(b) {
				...
				e.y += n;
				q =
					e.x + h[3] < g ? -h[3] : e.x - h[1] > k.width - c.width - g ? k.width - c.width + ("rtl" == f.lang.dir ? 0 : h[1]) : e.x;
				c = e.y + h[0] < g ? -h[0] : e.y - h[2] > k.height - c.height - g ? k.height - c.height + h[2] : e.y;
				q = Math.floor(q);
				c = Math.floor(c);
				a.move(q, c, 1);
		...
		function ca(a) {
			function b(b) {
				...
				C = Math.floor(C);
				w = Math.floor(w);
				if (e == CKEDITOR.DIALOG_RESIZE_WIDTH || e == CKEDITOR.DIALOG_RESIZE_BOTH) q = Math.max(d.minWidth || 0, w - g);
				if (e == CKEDITOR.DIALOG_RESIZE_HEIGHT ||
					e == CKEDITOR.DIALOG_RESIZE_BOTH) l = Math.max(d.minHeight || 0, C - h);
				a.resize(q, l);
			...
			if (e != CKEDITOR.DIALOG_RESIZE_NONE) {
				var f =
					a.getParentEditor(),
					g, h, p, m, k, q, l = CKEDITOR.tools.addFunction(function(e) {
						function d(a) {
							return a.isVisible()
						}
						k = a.getSize();
		...
		function P(a) {
			...
			f ? f.show() : (e = ['\x3cdiv tabIndex\x3d"-1" style\x3d"position: ', CKEDITOR.env.ie6Compat ? "absolute" : "fixed", "; z-index: ", e, "; top: 0px; left: 0px; ", "; width: 100%; height: 100%;",
				...
				e.push("\x3c/div\x3e"), f = CKEDITOR.dom.element.createFromHtml(e.join("")), f.setOpacity(void 0 !== c ? c : .5), f.on("keydown", J), f.on("keypress", J), f.on("keyup", J), f.appendTo(CKEDITOR.document.getBody()), D[b] = f);
		...
		function S(a) {
			var b = a.data.$.ctrlKey || a.data.$.metaKey,
				...
				d = a.data.$.shiftKey,
				e = String.fromCharCode(a.data.$.keyCode);
			(b = x[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + e]) && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key), a.data.preventDefault()))
		}
		...
		function da(a) {
			for (var b in x) {
				for (var c = x[b], d = c.length - 1; 0 <= d; d--) c[d].dialog != a && c[d].uiElement != a || c.splice(d, 1);
		...
		CKEDITOR.dialog = function(a, b) {
			...
			function e(b) {
				if (n == CKEDITOR.dialog._.currentTop) {
					...
					else if (-1 != CKEDITOR.tools.indexOf(g, c) && n._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([e ? 39 : 37, 38], c) ?
		...
		CKEDITOR.dialog.prototype = {
			...
			show: function() {
				...
				null === CKEDITOR.dialog._.currentZIndex && (CKEDITOR.dialog._.currentZIndex = d);
				...
				null === CKEDITOR.dialog._.currentTop ? (CKEDITOR.dialog._.currentTop = this, this._.parentDialog = null, P(this._.editor)) : (this._.parentDialog = CKEDITOR.dialog._.currentTop, c = this._.parentDialog.getElement().getFirst(), c.$.style.zIndex -=
					Math.floor(d / 2), this._.parentDialog.getElement().setStyle("z-index", c.$.style.zIndex), CKEDITOR.dialog._.currentTop = this);
				a.on("keydown", R);
				a.on("keyup", S);
				this._.hasFocus = !1;
					...
					if (!(4 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.uiElement.call(this, a, e || {
							...
							for (p = 0; p < c.length; p++) {
								...
								g ? g[p] && d.push("width:" + y(g[p])) : d.push("width:" + Math.floor(100 / c.length) + "%");
								h && d.push("height:" + y(h));
					...
					if (!(3 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.uiElement.call(this, a, e || {
							...
							for (var d = 0; d < c.length; d++) {
								...
								CKEDITOR.env.ie &&
									CKEDITOR.env.quirks && f[d].align && k.push("text-align:" + f[d].align);
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			openDialog: function(a, b, c) {
				...
				if ("function" == typeof e) e = this._.storedDialogs || (this._.storedDialogs = {}), d = e[a] || (e[a] = new CKEDITOR.dialog(this, a)), d.setModel(c), b && b.call(d, d), d.show();
					...
					if ("failed" == e) throw Q(this), Error('[CKEDITOR.dialog.openDialog] Dialog "' + a + '" failed when loading definition.');
		...
		CKEDITOR.plugins.copyformatting = {
			...
			_extractStylesFromElement: function(a, b) {
				var e = {},
					d = [];
				do
					if (b.type === CKEDITOR.NODE_ELEMENT && !b.hasAttribute("data-cke-bookmark") && (e.element = b, a.copyFormatting.fire("extractFormatting", e, a) && e.styleDef && d.push(new CKEDITOR.style(e.styleDef)), b.getName && -1 !== l(CKEDITOR.plugins.copyformatting.breakOnElements, b.getName()))) break;
				...
				a.pasteTools.register({
					...
					canHandle: function(a) {
						...
						var b = /(class=\"?Mso|style=(?:\"|\')[^\"]*?\bmso\-|w:WordDocument|<o:\w+>|<\/font>)/,
							b = /<meta\s*name=(?:\"|\')?generator(?:\"|\')?\s*content=(?:\"|\')?microsoft/gi.test(a) ||
							b.test(a);
						return a && (e || b)
					},
					handle: function(f, b) {
	...
	(function() {
		...
		function T(a) {
			...
			b.on("drop", function(c) {
				var e = c.data.dataTransfer,
					...
					e = b.createRange();
				"" !== f && g === CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? c.cancel() : "" !== f && g == CKEDITOR.DATA_TRANSFER_INTERNAL && (f = a.instances[f]) && (e.setStartBefore(f.wrapper), e.setEndAfter(f.wrapper), c.data.dragRange = e, delete CKEDITOR.plugins.clipboard.dragStartContainerChildCount, delete CKEDITOR.plugins.clipboard.dragEndContainerChildCount, c.data.dataTransfer.setData("text/html", f.getClipboardHtml()), b.widgets.destroy(f, !0))
			});
		...
		function R(a) {
			...
			b.on("contentDom", function() {
				...
				c.attachListener(d, "mousedown", function(c) {
					...
					f = 0;
					e && (e.inline && d.type == CKEDITOR.NODE_ELEMENT && d.hasAttribute("data-cke-widget-drag-handler") ? (f = 1, a.focused != e && b.getSelection().removeAllRanges()) : h.getNestedEditable(e.wrapper,
		...
		function Q(a) {
			...
			c.on("selectionChange", function(b) {
				...
				f ? f === e && f.focusedEditable.equals(b) || (p(a, f, null), e && b && p(a, e, b)) : e && b && p(a, e, b)
			});
			c.on("dataReady", function() {
				G(a).commit()
			});
			...
			b.on("toDataFormat", function(b) {
				...
				b.data.dataValue.forEach(function(b) {
					...
					if ("data-cke-widget-id" in c) {
						if (c = a.instances[c["data-cke-widget-id"]]) e = b.getFirst(h.isParserWidgetElement), f.push({
							wrapper: b,
							element: e,
							widget: c,
							editables: {}
						}), "1" != e.attributes["data-cke-widget-keep-attr"] && delete e.attributes["data-widget"]
					} else if ("data-cke-widget-editable" in c) return 0 < f.length &&
		...
		function N(a) {
			...
			b.on("toHtml", function(b) {
				...
				c = b.data.protectedWhitespaces ? 3 == b.data.dataValue.children.length && h.isParserWidgetWrapper(b.data.dataValue.children[1]) :
					1 == b.data.dataValue.children.length && h.isParserWidgetWrapper(b.data.dataValue.children[0])
			}, null, null, 8);
			b.on("dataReady", function() {
				if (d)
					for (var c = b.editable().find(".cke_widget_wrapper"), f, g, l = 0, k = c.count(); l < k; ++l) f = c.getItem(l), g = f.getFirst(h.isDomWidgetElement), g.type == CKEDITOR.NODE_ELEMENT && g.data("widget") ? (g.replace(f), a.wrapElement(g)) : f.remove();
				d = 0;
				a.destroyAll(!0);
				a.initOnAll()
			});
		...
		function G(a) {
			...
			return {
				...
				commit: function() {
					...
					for (f && (g = a.focused) && x(a, g); g = d.pop();) b.splice(CKEDITOR.tools.indexOf(b, g), 1), g.isInited() && (l = g.editor.checkDirty(), g.setSelected(!1), !l && g.editor.resetDirty());
		...
		function F(a, b) {
			...
			u.hasCopyBin(a) || (f = new u(a, {
				...
				afterDestroy: function() {
					b && !a.readOnly && (d ? a.widgets.del(d) : a.extractSelectedHtml(), a.fire("saveSnapshot"))
				}
			}), d || (e = CKEDITOR.env.webkit &&
		...
		function ga(a) {
			...
			a.editables = {};
			if (a.editables)
				for (c in b) d = b[c], a.initEditable(c, "string" ==
					typeof d ? {
						selector: d
					} : d)
		}
		...
		function ha(a) {
			if (!0 === a.mask) la(a);
				...
				if (CKEDITOR.env.gecko) {
					...
					CKEDITOR.tools.array.forEach(f.toArray(),
						function(a) {
							a.on("load", function() {
								b.input()
							})
		...
		function ma() {
			if (this.wrapper) {
				...
				if (a) {
					...
					if (c.offsetWidth != d.offsetWidth || c.offsetHeight != d.offsetHeight || e) c = a.getParent(), d = CKEDITOR.plugins.widget.isDomWidget(c),
						b.setStyles({
		...
		function ia(a) {
			if (a.draggable) {
				...
				if (!a.inline && (d.on("mousedown", na, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version)) d.on("dragstart", function(a) {
					a.data.preventDefault(!0)
				});
			...
			proto: {
				handle: function(a) {
					var b = this.copyBin,
						...
						p, r, q;
					b.setHtml('\x3cspan data-cke-copybin-start\x3d"1"\x3e​\x3c/span\x3e' +
						a + '\x3cspan data-cke-copybin-end\x3d"1"\x3e​\x3c/span\x3e');
					c.fire("lockSnapshot");
					d.append(b);
					c.editable().append(d);
